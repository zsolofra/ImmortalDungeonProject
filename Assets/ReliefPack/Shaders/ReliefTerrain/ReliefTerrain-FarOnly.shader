...
SubShader {
	...
	#pragma surface surf CustomBlinnPhong vertex:vert finalcolor:customFog  nolightmap
	// U5 fog handling
...
ZWrite Off
CGPROGRAM
	#pragma surface surf CustomBlinnPhong vertex:vert finalcolor:customFog decal:blend nolightmap
	// U5 fog handling
	#pragma multi_compile_fog	
	#include "UnityCG.cginc"
...
//Offset -1,-1
CGPROGRAM
	#pragma surface surf Lambert vertex:vert decal:add nolightmap
	#include "UnityCG.cginc"
